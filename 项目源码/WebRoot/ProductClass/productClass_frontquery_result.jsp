		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#productClassListPanel" aria-controls="productClassListPanel" role="tab" data-toggle="tab">图书分类列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ProductClass/productClass_frontAdd.jsp" style="display:none;">添加图书分类</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>图书分类id</td><td>图书分类名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<productClassList.size();i++) {
					    	            		...
					    	            		ProductClass productClass = productClassList.get(i); //获取到图书分类对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=productClass.getProductClassId() %></td>
 											<td><%=productClass.getProductName() %></td>
 											<td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;图书分类信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="productClass_productClassId_edit" class="col-md-3 text-right">图书分类id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="productClass_productClassId_edit" name="productClass.productClassId" class="form-control" placeholder="请输入图书分类id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="productClass_productName_edit" class="col-md-3 text-right">图书分类名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productClass_productName_edit" name="productClass.productName" class="form-control" placeholder="请输入图书分类名称">
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (productClass, response, status) {
			if (productClass) {
				...
				$("#productClass_productName_edit").val(productClass.productName);
