...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">书评平台网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- <li><a href="<%=basePath %>ProductClass/frontlist">图书分类</a></li> -->
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.productClassId=1">小说</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.productClassId=2">文学</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.productClassId=3">经济管理</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.productClassId=4">计算机与互联网</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.productClassId=5">人文社科</a></li>
                <!-- 
                <li><a href="<%=basePath %>UserInfo/frontlist">用户风采</a></li>
                <li><a href="<%=basePath %>ProductComment/frontlist">图书评论</a></li> -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>ProductComment/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的书评</a></li>
